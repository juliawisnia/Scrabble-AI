...
/* memory blocks available in array of memory blocks*/
            int used_mem_size;
/*controls size of used_memory*/
            void resize(Mem_Block** &used_memory, int active_requests, int &used_mem_size); 
/*bool array to tell what elements of buffer have been allocated*/
            bool array[BUF_SIZE];
